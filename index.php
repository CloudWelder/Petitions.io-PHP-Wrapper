   ...
   <div class="row">
    ...
    <div class="container">
        ...
        <header class="jumbotron hero-spacer">
            ...
            <p><a class="btn btn-primary btn-large" href="create_petition.php">Call to action!Start A petition</a>
            </p>
        </header>
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            <h6><?php echo $petition['signatures_count']; ?> Supporters!</h6> <a href="<?php echo "view_petition.php?petition_id=".$petition['id'] ?>" class="btn btn-default">More Info</a>
                        </p>
                    </div>
                </div>
            </div>
